...
2. Create a virtual environment using conda: "conda create -n ipcv-2 python=3.8"
3. Activate the virtual environment: "conda activate ipcv-2"
4. Install OpenCV packages: "pip install opencv-python open3d==0.16.0 numpy"
...
#### For example:
1. If just want to run the script without the Command Line Arguments, and get the result, just simply run: "python CWII2324-v2.py"
2. Run the script with custom parameters, for example: "python CWII2324-v2.py --display_centers", it will show the 3D render first, and after pressed ```esc```, it will display the centers.
...
#### Example
Run the script with custom parameters: "python CWII2324-v2.py --num=8 --sph_rad_min=12 --sph_rad_max=20 --display_centers"
...
## Key Functionalities
After ran the script: "python CWII2324-v2.py"
